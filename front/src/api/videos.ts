...
export function deleteMyVideo(data?: any) {
  return request({ url: '/user/delete-video', method: 'post', data })
}
...
export function commentDigg(params?: any, data?: any) {
  return request({ url: '/video/comment-digg', method: 'post', params, data })
}

export function deleteComment(params?: any, data?: any) {
  return request({ url: '/video/delete-comment', method: 'post', params, data })
}
